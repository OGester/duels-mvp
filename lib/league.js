...
export async function joinLeague(user_id, league_id, leagueRole) {
  ...
  //Should a user with leagueRole OWNER or ADMIN be accepted automatically when league
  //is not public to avoid the need to accept themselves?
...
export async function getLeagueMembers(league_id) {
  ...
  //creating a usable return object instead of nested data that the query returns
  //similar to a DTO
  //!!!! Risky to send the user_id in this object? !!!!
...
//testmethod while troubleshooting joining a league
